...
def main(page: ft.Page):
    ...
    page.window_height = 820  # Updated to 800
    ...
    def enforce_window_properties():
        while True:
            try:
                ...
                if window.width != 400 or window.height != 820:
                    window.resizeTo(400, 820)

                # Center the window (optional)
                window.moveTo((window.screen.width - 400) // 2, (window.screen.height - 820) // 2)
